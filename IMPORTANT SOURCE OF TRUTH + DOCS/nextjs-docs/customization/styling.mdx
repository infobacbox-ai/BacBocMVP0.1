...
To build the user interface supastarter comes with [Tailwind CSS](https://tailwindcss.com) and [Radix UI](https://radix-ui.com) pre-installed.

<Callout title="Why Tailwind CSS and Radix UI">
  The combination of Tailwind CSS and Radix UI allows gives ready-to-use,
  complex UI components that can be fully customized to match your brands
  design.
</Callout>
...
supastarter is also fully compatible with [shadcn/ui](https://ui.shadcn.com/), which is an amazing tool to quickly build your own component library with Radix UI and Tailwind CSS.
