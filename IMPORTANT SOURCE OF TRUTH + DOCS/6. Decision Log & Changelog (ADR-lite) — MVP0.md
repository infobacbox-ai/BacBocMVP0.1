...
**Date :** 2026-01-28  
**Dernière mise à jour :** 2026-01-29 (Slice 0.5 cleanup)  
...
**Statut :** Adopté  
**Note (2026-01-29) :** Drizzle ORM dependencies removed from `packages/database/package.json` as they were unused (no Drizzle code in codebase). Only Prisma is used for database operations. This aligns with the decision to lock Prisma as the sole ORM for MVP0.
