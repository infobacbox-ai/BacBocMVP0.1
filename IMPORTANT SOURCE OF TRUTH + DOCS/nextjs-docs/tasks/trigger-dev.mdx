...
Before we get started, make sure to create a new [trigger.dev](https://trigger.dev) and project.

You can find a full example of this recipe in the [feat/trigger.dev](https://github.com/triggerdotdev/supastarter-nextjs/tree/feat/trigger.dev) branch of the supastarter-nextjs repository.
...
Read the [trigger.dev documentation](https://docs.trigger.dev/tasks/create-a-task) for more information on how to create tasks or cron jobs.
