...
Recommended database providers are [Supabase](https://supabase.io/), [PlanetScale](https://planetscale.com) and [Neon](https://neon.tech/).

You can also find setup guides for certain providers in the [supastarter blog](https://supastarter.dev/blog):

- [Supabase](https://supastarter.dev/blog/supabase-integration)
...
*If you are using Supabase, you want to follow our [Supabase setup guide](/blog/supabase-integration) as you will need a second connection string for the database migration.*
...
_If you want to use a custom mail provider, use the `/packages/mail/src/providers/custom.ts` file and export from `custom.ts`._
...
Open [http://localhost:3000](http://localhost:3000) in your browser to see the your app.
